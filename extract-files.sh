...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/gps.SPH-D710.so:system/lib/hw/gps.s5pc210.so \\
    vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/gralloc.default.so:system/lib/hw/gralloc.default.so \\
    vendor/__MANUFACTURER__/__COMMON__/proprietary/hw/gralloc.SPH-D710.so:system/lib/hw/gralloc.SPH-D710.so
